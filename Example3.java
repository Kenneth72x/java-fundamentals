...
class Example3 {
    public static void main(String args[]) {
        ...
        System.out.println("v after division: " + v); //output shows fractional component lost
        System.out.println("x after division: " + x); //output shows fractional component preserved
    }
}
